...
reinterpret_cast<TARGET_TYPE*>(processDynamicCast( TYPEID(PtrToMostDerivedPtr[OBJ_PTR]), TypeNameToTypeInfo[#TARGET_TYPE], reinterpret_cast<void*>(PtrToMostDerivedPtr[OBJ_PTR])))
